...
public class ExprEffectCloudReapplicationDelay
  extends SimplePropertyExpression<Entity, Number>
{
  public Number convert(Entity ent)
  {
    ...
    return Integer.valueOf(((AreaEffectCloud)ent).getReapplicationDelay());
  }
  ...
  public void change(Event e, Object[] delta, Changer.ChangeMode mode)
  {
    ...
    if (mode == Changer.ChangeMode.SET) {
      ((AreaEffectCloud)ent).setReapplicationDelay(b.intValue());
    }
  }
  ...
  {
    return "area effect cloud reapplication delay";
  }
}
