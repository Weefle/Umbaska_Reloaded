...
public class ExprEffectCloudDurationOnUse
  extends SimplePropertyExpression<Entity, Number>
{
  public Number convert(Entity ent)
  {
    ...
    return Integer.valueOf(((AreaEffectCloud)ent).getDurationOnUse());
  }
  ...
  public void change(Event e, Object[] delta, Changer.ChangeMode mode)
  {
    ...
    if (mode == Changer.ChangeMode.SET) {
      ((AreaEffectCloud)ent).setDurationOnUse(b.intValue());
    }
  }
  ...
  {
    return "area effect cloud duration on use";
  }
}
