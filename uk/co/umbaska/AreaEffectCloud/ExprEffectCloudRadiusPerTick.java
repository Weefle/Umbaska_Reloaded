...
public class ExprEffectCloudRadiusPerTick
  extends SimplePropertyExpression<Entity, Number>
{
  public Number convert(Entity ent)
  {
    ...
    return Float.valueOf(((AreaEffectCloud)ent).getRadiusPerTick());
  }
  ...
  public void change(Event e, Object[] delta, Changer.ChangeMode mode)
  {
    ...
    if (mode == Changer.ChangeMode.SET) {
      ((AreaEffectCloud)ent).setRadiusPerTick(b.intValue());
    }
  }
  ...
  {
    return "area effect cloud radius per tick";
  }
}
