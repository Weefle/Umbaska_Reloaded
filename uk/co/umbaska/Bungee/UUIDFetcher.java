...
public class UUIDFetcher implements java.util.concurrent.Callable<Map<String, UUID>>
{
  ...
  public Map<String, UUID> call() throws Exception {
    ...
    for (int i = 0; i < requests; i++) {
      ...
      JSONArray array = (JSONArray)this.jsonParser.parse(new java.io.InputStreamReader(connection.getInputStream()));
  ...
  public static UUID getUUIDOf(String name) throws Exception {
    return (UUID)new UUIDFetcher(java.util.Arrays.asList(new String[] { name })).call().get(name);
  }
}
