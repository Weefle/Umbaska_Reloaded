...
public static Class getClass(String classname)
  ...
  public static void registerAll()
  {
    ...
    if (pl != null) {
      ...
      EventValues.registerEventValue(com.plotsquared.bukkit.events.PlayerPlotDeniedEvent.class, String.class, new Getter<String, PlayerPlotDeniedEvent>()
      {
      ...
      EventValues.registerEventValue(PlayerPlotHelperEvent.class, String.class, new Getter<String, PlayerPlotHelperEvent>()
      {
      ...
      EventValues.registerEventValue(PlayerPlotTrustedEvent.class, String.class, new Getter<String, PlayerPlotTrustedEvent>()
      {
      ...
      EventValues.registerEventValue(PlayerTeleportToPlotEvent.class, String.class, new Getter<String, PlayerTeleportToPlotEvent>()
      {
      ...
      EventValues.registerEventValue(PlotClearEvent.class, String.class, new Getter<String, PlotClearEvent>()
      {
      ...
      EventValues.registerEventValue(PlotFlagAddEvent.class, String.class, new Getter<String, PlotFlagAddEvent>()
      {
      ...
      EventValues.registerEventValue(PlotFlagRemoveEvent.class, String.class, new Getter<String, PlotFlagRemoveEvent>()
      {
      ...
      EventValues.registerEventValue(PlotMergeEvent.class, String.class, new Getter<String, PlotMergeEvent>()
      {
        public String get(PlotMergeEvent event) { return event.getPlots().toArray(new String[event.getPlots().size()]).toString(); } }, 0);
      


      Skript.registerEvent("PlotSquared Rate", SimpleEvent.class, PlotRateEvent.class, new String[] { "plot rate" });
      EventValues.registerEventValue(PlotRateEvent.class, String.class, new Getter<String, PlotRateEvent>()
      {
      ...
      EventValues.registerEventValue(PlotUnlinkEvent.class, String.class, new Getter<String, PlotUnlinkEvent>()
      {
        public String get(PlotUnlinkEvent event) { return event.getPlots().toArray(new String[event.getPlots().size()]).toString(); } }, 0);
...
*/
    ...
    EventValues.registerEventValue(BrewEvent.class, ItemStack[].class, new Getter<ItemStack[], BrewEvent>()
    {
    ...
    if (Main.getInstance().getConfig().getBoolean("enable_variable_change_event")) {
      ...
      EventValues.registerEventValue(VariableChangeEvent.class, String.class, new Getter<String, VariableChangeEvent>()
      {
        public String get(VariableChangeEvent event) { return event.getVariable(); } }, 0);
      

      EventValues.registerEventValue(VariableChangeEvent.class, Object.class, new Getter<Object, VariableChangeEvent>()
      {
    ...
    EventValues.registerEventValue(EvtHeadRotateEvent.class, Player.class, new Getter<Player, EvtHeadRotateEvent>()
    {
    ...
    EventValues.registerEventValue(EvtRepairEvent.class, Player.class, new Getter<Player, EvtRepairEvent>()
    {
    ...
    EventValues.registerEventValue(EvtRepairEvent.class, ItemStack.class, new Getter<ItemStack, EvtRepairEvent>()
    {
    ...
    EventValues.registerEventValue(EvtTeleportCallEvent.class, Player.class, new Getter<Player, EvtTeleportCallEvent>()
    {
    ...
    EventValues.registerEventValue(EvtCropGrowEvent.class, ch.njol.skript.util.BlockStateBlock.class, new Getter<BlockStateBlock, EvtCropGrowEvent>()
    {
    ...
    Skript.registerEvent("Entity Interact", SimpleEvent.class, PlayerInteractAtEntityEvent.class, new String[] { "([entity] interact|armo[u]r stand (right[ ]click|interact))" });
    Skript.registerEvent("Entity Interact", SimpleEvent.class, PlayerInteractAtEntityEvent.class, new String[] { "([entity] interact|armo[u]r stand (right[ ]click|interact))" });
    EventValues.registerEventValue(PlayerInteractAtEntityEvent.class, org.bukkit.util.Vector.class, new Getter<Vector, PlayerInteractAtEntityEvent>()
    {
    ...
    if (!Main.disableSkRambled.booleanValue())
    {
     Plugin pl = org.bukkit.Bukkit.getServer().getPluginManager().getPlugin("Factions");
      if (pl != null) {
        ...
        EventValues.registerEventValue(EvtFactionDescriptionChangeEvent.class, Player.class, new Getter<Player, EvtFactionDescriptionChangeEvent>()
        {
        ...
        EventValues.registerEventValue(EvtFactionDescriptionChangeEvent.class, com.massivecraft.factions.entity.Faction.class, new Getter<Faction, EvtFactionDescriptionChangeEvent>()
        {
        ...
        EventValues.registerEventValue(EvtFactionDescriptionChangeEvent.class, String.class, new Getter<String, EvtFactionDescriptionChangeEvent>()
        {
        ...
        EventValues.registerEventValue(EvtFactionNameChangeEvent.class, Player.class, new Getter<Player, EvtFactionNameChangeEvent>()
        {
        ...
        EventValues.registerEventValue(EvtFactionNameChangeEvent.class, com.massivecraft.factions.entity.Faction.class, new Getter<Faction, EvtFactionNameChangeEvent>()
        {
        ...
        EventValues.registerEventValue(EvtFactionCreateEvent.class, Player.class, new Getter<Player, EvtFactionCreateEvent>()
        {
        ...
        EventValues.registerEventValue(EvtFactionCreateEvent.class, String.class, new Getter<String, EvtFactionCreateEvent>()
        {
        ...
        EventValues.registerEventValue(EvtFactionDisbandEvent.class, Player.class, new Getter<Player, EvtFactionDisbandEvent>()
        {
        ...
        EventValues.registerEventValue(EvtFactionDisbandEvent.class, String.class, new Getter<String, EvtFactionDisbandEvent>()
        {
      ...
      if (pl != null) {
        ...
        EventValues.registerEventValue(EvtRegionEnterEvent.class, Player.class, new Getter<Player, EvtRegionEnterEvent>()
        {
        ...
        EventValues.registerEventValue(EvtRegionEnterEvent.class, com.sk89q.worldguard.protection.regions.ProtectedRegion.class, new Getter<ProtectedRegion, EvtRegionEnterEvent>()
        {
