...
public class ExprCurrentLocation extends SimplePropertyExpression<String, Location>
{
  public Location convert(String ent)
  {
    ...
    if (ParticleProjectileHandler.particleProjectiles.containsKey(ent)) {
      return ((ParticleProjectile)ParticleProjectileHandler.particleProjectiles.get(ent)).getCurrentLocation();
    }
    return null;
  }
  ...
  public void change(Event e, Object[] delta, Changer.ChangeMode mode)
  {
    ...
    ((ParticleProjectile)ParticleProjectileHandler.particleProjectiles.get(ent)).setCurrentLocation(b);
  }
