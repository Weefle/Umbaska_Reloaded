...
public class ExprParticleData2 extends SimplePropertyExpression<String, Number>
{
  public Number convert(String ent)
  {
    ...
    if (ParticleProjectileHandler.particleProjectiles.containsKey(ent)) {
      return ((ParticleProjectile)ParticleProjectileHandler.particleProjectiles.get(ent)).getParticleData2();
    }
    return null;
  }
  ...
  public void change(Event e, Object[] delta, Changer.ChangeMode mode)
  {
    ...
    ((ParticleProjectile)ParticleProjectileHandler.particleProjectiles.get(ent)).setParticleData2(Integer.valueOf(b.intValue()));
  }
