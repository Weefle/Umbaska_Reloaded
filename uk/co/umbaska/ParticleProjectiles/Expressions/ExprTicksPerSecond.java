...
public class ExprTicksPerSecond extends SimplePropertyExpression<String, Number>
{
  public Number convert(String ent)
  {
    ...
    if (ParticleProjectileHandler.particleProjectiles.containsKey(ent)) {
      return Integer.valueOf(((ParticleProjectile)ParticleProjectileHandler.particleProjectiles.get(ent)).getTicksPerSecond());
    }
    return null;
  }
  ...
  public void change(Event e, Object[] delta, Changer.ChangeMode mode)
  {
    ...
    ((ParticleProjectile)ParticleProjectileHandler.particleProjectiles.get(ent)).setTicksPerSecond(b.intValue());
  }
