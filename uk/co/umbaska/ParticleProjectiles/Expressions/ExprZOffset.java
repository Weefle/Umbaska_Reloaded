...
public class ExprZOffset extends SimplePropertyExpression<String, Number>
{
  public Number convert(String ent)
  {
    ...
    if (ParticleProjectileHandler.particleProjectiles.containsKey(ent)) {
      return ((ParticleProjectile)ParticleProjectileHandler.particleProjectiles.get(ent)).getZoff();
    }
    return null;
  }
  ...
  public void change(Event e, Object[] delta, Changer.ChangeMode mode)
  {
    ...
    ((ParticleProjectile)ParticleProjectileHandler.particleProjectiles.get(ent)).setOffset(p.getXoff(), p.getYoff(), Double.valueOf(b.doubleValue()));
  }
